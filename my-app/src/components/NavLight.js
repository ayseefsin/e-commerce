export const NavLight = () => {
  return (
    <div className="flex bg-[#FFF] font-navText justify-between items-center px-[5vw] py-[1vw] ">
      <div className="flex items-center text-2xl font-bold text-[#252B42] h-[3.625rem] py-[0.813rem] pl-[1.063rem] pr-[2.375rem] tracking-[.00625em] ">
        ...
        <div className="flex gap-[0.938rem] h-[3.625rem] justify-center items-center pl-10 py-0.5 text-[#737373] text-[0.875rem] font-bold font-navText tracking-[.0125em]">
          ...
          <div className="flex items-center">
            <a className="font-medium text-[#252B42]">Shop</a>
            <svg
      ...
      <div className="flex h-[3.625rem]">
        <div className="flex text-main-blue font-bold text-sm py-[0.938rem] items-center gap-[2.75rem]">
          <div className="flex gap-[0.313rem] items-center">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_2984_6797)">
                <path
          ...
          <div className="flex text-xs font-normal gap-[.313rem] ">
            <div className="flex p-[0.938rem] ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <div className="flex p-[0.938rem] ">
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_2984_6808)">
                  <path
